<template>
  ...
  >
    ...
    >
      <!-- 左部操作区域 -->
      <div class="left-operation-area" :style="{ width: '37px' }">
      ...
      >
        ...
        <div class="video-line" :style="{ width: timescale_width + 'px' }">
          ...
          ></video-item>
          <!-- 时间轴指针 -->
          <div data-style-left="20px" class="timeline-play-cursor active" style="transform: translate(20px, 0px);">
            <div class="timeline-play-cursor-hd">
            </div>
            <div class="timeline-play-cursor-bd">
            </div>
          </div>
        </div>
      </div>
      ...
      .timeline-play-cursor {
        ...
        .timeline-play-cursor-hd {
          ...
          &：after {
            ...
            border-bottom: 2px solid rgb(242, 234, 234);
